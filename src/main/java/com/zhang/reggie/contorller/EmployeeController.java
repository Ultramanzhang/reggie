package com.zhang.reggie.contorller;
...
import com.zhang.reggie.service.EmployeeServie;
...
public class EmployeeController {
     ...
     */
    @PostMapping("/login")
    public R<Employee> loging(HttpServletRequest request, @RequestBody Employee employee) {
